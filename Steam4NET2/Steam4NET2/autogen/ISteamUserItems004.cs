...
namespace Steam4NET
{
	...
	public class ISteamUserItems004VTable
	{
		...
		public IntPtr DeleteItem6;
		public IntPtr GetItemBlob7;
		public IntPtr SetItemBlob8;
		public IntPtr DropItem9;
		private IntPtr DTorISteamUserItems00410;
	};
	
	public class ISteamUserItems004 : InteropHelp.NativeWrapper<ISteamUserItems004VTable>
	{
		...
		[UnmanagedFunctionPointer(CallingConvention.ThisCall)] private delegate Int32 NativeDeleteItemU( IntPtr thisptr, UInt64 itemId );
		public Int32 DeleteItem( UInt64 itemId ) 
		{
			return this.GetFunction<NativeDeleteItemU>( this.Functions.DeleteItem6 )( this.ObjectAddress, itemId ); 
		}
		...
		{
			this.GetFunction<NativeDropItemU>( this.Functions.DropItem9 )( this.ObjectAddress, itemId ); 
		}
