...
namespace Steam4NET
{
	...
	public class ISteamUserStats001 : InteropHelp.NativeWrapper<ISteamUserStats001VTable>
	{
		...
		{
			return Marshal.PtrToStringAnsi( this.GetFunction<NativeGetGroupAchievementNameCU>( this.Functions.GetGroupAchievementName6 )( this.ObjectAddress, arg0.ConvertToUint64(), iAchievement ) ); 
		}
		...
		{
			return Marshal.PtrToStringAnsi( this.GetFunction<NativeGetAchievementDisplayAttributeCSS>( this.Functions.GetAchievementDisplayAttribute21 )( this.ObjectAddress, nGameID.ConvertToUint64(), pchName, pchKey ) ); 
		}
