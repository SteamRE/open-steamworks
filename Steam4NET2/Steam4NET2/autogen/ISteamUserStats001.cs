...
namespace Steam4NET
{
	...
	public class ISteamUserStats001 : InteropHelp.NativeWrapper<ISteamUserStats001VTable>
	{
		...
		[UnmanagedFunctionPointer(CallingConvention.ThisCall)] private delegate string NativeGetGroupAchievementNameCU( IntPtr thisptr, UInt64 arg0, UInt32 iAchievement );
		public string GetGroupAchievementName( CGameID arg0, UInt32 iAchievement ) 
		{
			return InteropHelp.DecodeANSIReturn( this.GetFunction<NativeGetGroupAchievementNameCU>( this.Functions.GetGroupAchievementName6 )( this.ObjectAddress, arg0.ConvertToUint64(), iAchievement ) ); 
		}
		...
		{
			return this.GetFunction<NativeGetStatCSI>( this.Functions.GetStat8 )( this.ObjectAddress, nGameID.ConvertToUint64(), pchName, ref pData ); 
		}
		...
		{
			return this.GetFunction<NativeGetStatCSF>( this.Functions.GetStat9 )( this.ObjectAddress, nGameID.ConvertToUint64(), pchName, ref pData ); 
		}
		...
		{
			return this.GetFunction<NativeSetStatCSI>( this.Functions.SetStat10 )( this.ObjectAddress, nGameID.ConvertToUint64(), pchName, nData ); 
		}
		...
		{
			return this.GetFunction<NativeSetStatCSF>( this.Functions.SetStat11 )( this.ObjectAddress, nGameID.ConvertToUint64(), pchName, fData ); 
		}
		...
		{
			return InteropHelp.DecodeANSIReturn( this.GetFunction<NativeGetAchievementDisplayAttributeCSS>( this.Functions.GetAchievementDisplayAttribute21 )( this.ObjectAddress, nGameID.ConvertToUint64(), pchName, pchKey ) ); 
		}
