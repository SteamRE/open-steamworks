...
namespace Steam4NET
{
	...
	public class ISteamUserStats009 : InteropHelp.NativeWrapper<ISteamUserStats009VTable>
	{
		...
		[UnmanagedFunctionPointer(CallingConvention.ThisCall)] private delegate Int32 NativeDownloadLeaderboardEntriesForUsers( IntPtr thisptr );
		public Int32 DownloadLeaderboardEntriesForUsers(  ) 
		{
			return this.GetFunction<NativeDownloadLeaderboardEntriesForUsers>( this.Functions.DownloadLeaderboardEntriesForUsers27 )( this.ObjectAddress ); 
		}
