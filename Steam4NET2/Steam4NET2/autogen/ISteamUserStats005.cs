...
namespace Steam4NET
{
	...
	public class ISteamUserStats005 : InteropHelp.NativeWrapper<ISteamUserStats005VTable>
	{
		...
		{
			UInt64 ret = 0; this.GetFunction<NativeFindLeaderboardS>( this.Functions.FindLeaderboard19 )( this.ObjectAddress, ref ret, pchLeaderboardName ); return (UInt64)ret;
		}
		...
		[UnmanagedFunctionPointer(CallingConvention.ThisCall)] private delegate UInt64 NativeUploadLeaderboardScoreUIII( IntPtr thisptr, ref UInt64 retarg, UInt64 hSteamLeaderboard, Int32 nScore, ref Int32 pScoreDetails, Int32 cScoreDetailsCount );
		...
		{
			UInt64 ret = 0; this.GetFunction<NativeUploadLeaderboardScoreUIII>( this.Functions.UploadLeaderboardScore26 )( this.ObjectAddress, ref ret, hSteamLeaderboard, nScore, ref pScoreDetails, cScoreDetailsCount ); return (UInt64)ret;
		}
