...
namespace Steam4NET
{
	...
	public class ISteamClient008 : InteropHelp.NativeWrapper<ISteamClient008VTable>
	{
		...
		{
			return InteropHelp.CastInterface<TClass>( this.GetFunction<NativeGetISteamAppsIIS>( this.Functions.GetISteamApps15 )( this.ObjectAddress, hSteamUser, hSteamPipe, InterfaceVersions.GetIFace( typeof( TClass ) ) ) ); 
		}
		...
		{
			return InteropHelp.CastInterface<TClass>( this.GetFunction<NativeGetISteamNetworkingIIS>( this.Functions.GetISteamNetworking16 )( this.ObjectAddress, hSteamUser, hSteamPipe, InterfaceVersions.GetIFace( typeof( TClass ) ) ) ); 
		}
		...
		{
			return InteropHelp.CastInterface<TClass>( this.GetFunction<NativeGetISteamRemoteStorageIIS>( this.Functions.GetISteamRemoteStorage17 )( this.ObjectAddress, hSteamuser, hSteamPipe, InterfaceVersions.GetIFace( typeof( TClass ) ) ) ); 
		}
