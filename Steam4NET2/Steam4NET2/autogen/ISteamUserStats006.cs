...
namespace Steam4NET
{
	...
	public class ISteamUserStats006 : InteropHelp.NativeWrapper<ISteamUserStats006VTable>
	{
		...
		{
			UInt64 ret = 0; this.GetFunction<NativeUploadLeaderboardScoreUEIII>( this.Functions.UploadLeaderboardScore26 )( this.ObjectAddress, ref ret, hSteamLeaderboard, eLeaderboardUploadScoreMethod, nScore, ref pScoreDetails, cScoreDetailsCount ); return (UInt64)ret;
		}
		...
		{
			UInt64 ret = 0; this.GetFunction<NativeGetNumberOfCurrentPlayers>( this.Functions.GetNumberOfCurrentPlayers27 )( this.ObjectAddress, ref ret ); return (UInt64)ret;
		}
