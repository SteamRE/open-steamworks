...
namespace Steam4NET
{
	...
	public class ISteamRemoteStorage006VTable
	{
		...
		public IntPtr UpdatePublishedFileURL47;
		private IntPtr DTorISteamRemoteStorage00648;
	};
	...
	public class ISteamRemoteStorage006 : InteropHelp.NativeWrapper<ISteamRemoteStorage006VTable>
	{
		...
		{
			return this.GetFunction<NativeUpdatePublishedFileURLUS>( this.Functions.UpdatePublishedFileURL47 )( this.ObjectAddress, hUpdateRequest, cszURL ); 
		}
