...
namespace Steam4NET
{
	...
	public class IClientGameServerVTable
	{
		...
		public IntPtr ForceHeartbeatViaCM53;
		public IntPtr _BGetUserAchievementStatus54;
		public IntPtr _GSSetSpawnCount55;
		public IntPtr _GSGetSteam2GetEncryptionKeyToSendToNewClient56;
		public IntPtr _GSSendSteam2UserConnect57;
		public IntPtr _GSSendSteam3UserConnect58;
		public IntPtr _GSSendUserConnect59;
		public IntPtr _GSRemoveUserConnect60;
		public IntPtr _GSUpdateStatus61;
		public IntPtr _GSCreateUnauthenticatedUser62;
		public IntPtr _GSSetServerType63;
		public IntPtr _SetBasicServerData64;
		public IntPtr _GSSendUserDisconnect65;
		private IntPtr DTorIClientGameServer66;
	};
	...
	public class IClientGameServer : InteropHelp.NativeWrapper<IClientGameServerVTable>
	{
		...
		[UnmanagedFunctionPointer(CallingConvention.ThisCall)] private delegate void NativeForceHeartbeatViaCM( IntPtr thisptr );
		public void ForceHeartbeatViaCM(  ) 
		{
			this.GetFunction<NativeForceHeartbeatViaCM>( this.Functions.ForceHeartbeatViaCM53 )( this.ObjectAddress ); 
		}
		...
		{
			return this.GetFunction<Native_BGetUserAchievementStatusCS>( this.Functions._BGetUserAchievementStatus54 )( this.ObjectAddress, steamID.ConvertToUint64(), pchAchievementName ); 
		}
		...
		{
			this.GetFunction<Native_GSSetSpawnCountU>( this.Functions._GSSetSpawnCount55 )( this.ObjectAddress, ucSpawn ); 
		}
		...
		{
			return this.GetFunction<Native_GSGetSteam2GetEncryptionKeyToSendToNewClientBUU>( this.Functions._GSGetSteam2GetEncryptionKeyToSendToNewClient56 )( this.ObjectAddress, pvEncryptionKey, ref pcbEncryptionKey, cbMaxEncryptionKey ); 
		}
		...
		{
			return this.GetFunction<Native_GSSendSteam2UserConnectUBUUUBU>( this.Functions._GSSendSteam2UserConnect57 )( this.ObjectAddress, unUserID, pvRawKey, (UInt32) pvRawKey.Length, unIPPublic, usPort, pvCookie, (UInt32) pvCookie.Length ); 
		}
		...
		{
			return this.GetFunction<Native_GSSendSteam3UserConnectCUBU>( this.Functions._GSSendSteam3UserConnect58 )( this.ObjectAddress, steamID.ConvertToUint64(), unIPPublic, pvCookie, (UInt32) pvCookie.Length ); 
		}
		...
		{
			return this.GetFunction<Native_GSSendUserConnectUUUBU>( this.Functions._GSSendUserConnect59 )( this.ObjectAddress, unUserID, unIPPublic, usPort, pvCookie, (UInt32) pvCookie.Length ); 
		}
		...
		{
			return this.GetFunction<Native_GSRemoveUserConnectU>( this.Functions._GSRemoveUserConnect60 )( this.ObjectAddress, unUserID ); 
		}
		...
		{
			return this.GetFunction<Native_GSUpdateStatusIIISSS>( this.Functions._GSUpdateStatus61 )( this.ObjectAddress, cPlayers, cPlayersMax, cBotPlayers, pchServerName, pSpectatorServerName, pchMapName ); 
		}
		...
		{
			UInt64 s0 = 0; var result = this.GetFunction<Native_GSCreateUnauthenticatedUserC>( this.Functions._GSCreateUnauthenticatedUser62 )( this.ObjectAddress, ref s0 ); pSteamID = new CSteamID(s0); return result;
		}
		...
		{
			return this.GetFunction<Native_GSSetServerTypeIUUUUUSSB>( this.Functions._GSSetServerType63 )( this.ObjectAddress, iAppID, unServerFlags, unGameIP, unGamePort, unSpectatorPort, usQueryPort, pchGameDir, pchVersion, bLANMode ); 
		}
		...
		{
			this.GetFunction<Native_SetBasicServerDataUBSSUBS>( this.Functions._SetBasicServerData64 )( this.ObjectAddress, nProtocolVersion, bDedicatedServer, pRegionName, pProductName, nMaxReportedClients, bPasswordProtected, pGameDescription ); 
		}
		...
		{
			return this.GetFunction<Native_GSSendUserDisconnectCU>( this.Functions._GSSendUserDisconnect65 )( this.ObjectAddress, arg0.ConvertToUint64(), unUserID ); 
		}
