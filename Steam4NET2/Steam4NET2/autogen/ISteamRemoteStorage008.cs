...
namespace Steam4NET
{
	...
	public class ISteamRemoteStorage008 : InteropHelp.NativeWrapper<ISteamRemoteStorage008VTable>
	{
		...
		{
			return Marshal.PtrToStringAnsi( this.GetFunction<NativeGetFileNameAndSizeII>( this.Functions.GetFileNameAndSize16 )( this.ObjectAddress, iFile, ref pnFileSizeInBytes ) ); 
		}
