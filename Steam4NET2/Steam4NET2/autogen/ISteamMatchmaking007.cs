...
namespace Steam4NET
{
	...
	public class ISteamMatchmaking007 : InteropHelp.NativeWrapper<ISteamMatchmaking007VTable>
	{
		...
		{
			UInt64 ret = 0; this.GetFunction<NativeCreateLobbyEI>( this.Functions.CreateLobby10 )( this.ObjectAddress, ref ret, eLobbyType, cMaxMembers ); return (UInt64)ret;
		}
		...
		{
			return InteropHelp.DecodeANSIReturn( this.GetFunction<NativeGetLobbyMemberDataCCS>( this.Functions.GetLobbyMemberData21 )( this.ObjectAddress, steamIDLobby.ConvertToUint64(), steamIDUser.ConvertToUint64(), pchKey ) ); 
		}
