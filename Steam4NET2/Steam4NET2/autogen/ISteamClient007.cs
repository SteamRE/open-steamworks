...
namespace Steam4NET
{
	...
	public class ISteamClient007 : InteropHelp.NativeWrapper<ISteamClient007VTable>
	{
		...
		{
			return InteropHelp.CastInterface<TClass>( this.GetFunction<NativeGetISteamContentServerIIS>( this.Functions.GetISteamContentServer11 )( this.ObjectAddress, hSteamUser, hSteamPipe, InterfaceVersions.GetIFace( typeof( TClass ) ) ) ); 
		}
		...
		{
			return InteropHelp.CastInterface<TClass>( this.GetFunction<NativeGetISteamMasterServerUpdaterIIS>( this.Functions.GetISteamMasterServerUpdater12 )( this.ObjectAddress, hSteamUser, hSteamPipe, InterfaceVersions.GetIFace( typeof( TClass ) ) ) ); 
		}
		...
		{
			return InteropHelp.CastInterface<TClass>( this.GetFunction<NativeGetISteamMatchmakingServersIIS>( this.Functions.GetISteamMatchmakingServers13 )( this.ObjectAddress, hSteamUser, hSteamPipe, InterfaceVersions.GetIFace( typeof( TClass ) ) ) ); 
		}
		...
		{
			return InteropHelp.CastInterface<TClass>( this.GetFunction<NativeGetISteamGenericInterfaceIIS>( this.Functions.GetISteamGenericInterface14 )( this.ObjectAddress, hSteamUser, hSteamPipe, InterfaceVersions.GetIFace( typeof( TClass ) ) ) ); 
		}
		...
		{
			return InteropHelp.CastInterface<TClass>( this.GetFunction<NativeGetISteamUserStatsIIS>( this.Functions.GetISteamUserStats17 )( this.ObjectAddress, hSteamUser, hSteamPipe, InterfaceVersions.GetIFace( typeof( TClass ) ) ) ); 
		}
		...
		{
			return InteropHelp.CastInterface<TClass>( this.GetFunction<NativeGetISteamAppsIIS>( this.Functions.GetISteamApps18 )( this.ObjectAddress, hSteamUser, hSteamPipe, InterfaceVersions.GetIFace( typeof( TClass ) ) ) ); 
		}
		...
		{
			return InteropHelp.CastInterface<TClass>( this.GetFunction<NativeGetISteamNetworkingIIS>( this.Functions.GetISteamNetworking19 )( this.ObjectAddress, hSteamUser, hSteamPipe, InterfaceVersions.GetIFace( typeof( TClass ) ) ) ); 
		}
		...
		{
			return InteropHelp.CastInterface<TClass>( this.GetFunction<NativeGetISteamRemoteStorageIIS>( this.Functions.GetISteamRemoteStorage21 )( this.ObjectAddress, hSteamuser, hSteamPipe, InterfaceVersions.GetIFace( typeof( TClass ) ) ) ); 
		}
