...
namespace Steam4NET
{
	...
	public class ISteamMatchmaking002 : InteropHelp.NativeWrapper<ISteamMatchmaking002VTable>
	{
		...
		{
			return InteropHelp.DecodeANSIReturn( this.GetFunction<NativeGetLobbyDataCS>( this.Functions.GetLobbyData12 )( this.ObjectAddress, SteamIDLobby.ConvertToUint64(), pchKey ) ); 
		}
		...
		{
			return InteropHelp.DecodeANSIReturn( this.GetFunction<NativeGetLobbyMemberDataCCS>( this.Functions.GetLobbyMemberData14 )( this.ObjectAddress, steamIDLobby.ConvertToUint64(), steamIDUser.ConvertToUint64(), pchKey ) ); 
		}
