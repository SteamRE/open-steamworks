...
namespace Steam4NET
{
	...
	public class ISteamFriends002 : InteropHelp.NativeWrapper<ISteamFriends002VTable>
	{
		...
		{
			return this.GetFunction<NativeGetFriendCountI>( this.Functions.GetFriendCount4 )( this.ObjectAddress, iFriendFlags ); 
		}
		...
		{
			UInt64 ret = 0; this.GetFunction<NativeGetFriendByIndexII>( this.Functions.GetFriendByIndex5 )( this.ObjectAddress, ref ret, iFriend, iFriendFlags ); return new CSteamID(ret);
		}
		...
		{
			return InteropHelp.DecodeANSIReturn( this.GetFunction<NativeGetFriendPersonaNameC>( this.Functions.GetFriendPersonaName8 )( this.ObjectAddress, steamIDFriend.ConvertToUint64() ) ); 
		}
		...
		{
			return InteropHelp.DecodeANSIReturn( this.GetFunction<NativeGetFriendRegValueCS>( this.Functions.GetFriendRegValue10 )( this.ObjectAddress, steamIDFriend.ConvertToUint64(), pchKey ) ); 
		}
		...
		{
			return InteropHelp.DecodeANSIReturn( this.GetFunction<NativeGetFriendPersonaNameHistoryCI>( this.Functions.GetFriendPersonaNameHistory12 )( this.ObjectAddress, steamIDFriend.ConvertToUint64(), iPersonaName ) ); 
		}
		...
		{
			return this.GetFunction<NativeHasFriendCI>( this.Functions.HasFriend15 )( this.ObjectAddress, steamIDFriend.ConvertToUint64(), iFriendFlags ); 
		}
