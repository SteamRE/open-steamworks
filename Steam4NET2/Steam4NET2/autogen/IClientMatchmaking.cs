...
namespace Steam4NET
{
	...
	public class IClientMatchmaking : InteropHelp.NativeWrapper<IClientMatchmakingVTable>
	{
		...
		{
			return Marshal.PtrToStringAnsi( this.GetFunction<NativeGetLobbyDataCS>( this.Functions.GetLobbyData19 )( this.ObjectAddress, steamIDLobby.ConvertToUint64(), pchKey ) ); 
		}
		...
		{
			return Marshal.PtrToStringAnsi( this.GetFunction<NativeGetLobbyMemberDataCCS>( this.Functions.GetLobbyMemberData24 )( this.ObjectAddress, steamIDLobby.ConvertToUint64(), steamIDUser.ConvertToUint64(), pchKey ) ); 
		}
