...
namespace Steam4NET
{
	...
	public class IClientMatchmaking : InteropHelp.NativeWrapper<IClientMatchmakingVTable>
	{
		...
		{
			return InteropHelp.DecodeANSIReturn( this.GetFunction<NativeGetLobbyMemberDataCCS>( this.Functions.GetLobbyMemberData24 )( this.ObjectAddress, steamIDLobby.ConvertToUint64(), steamIDUser.ConvertToUint64(), pchKey ) ); 
		}
