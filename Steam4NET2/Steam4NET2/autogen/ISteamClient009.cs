...
namespace Steam4NET
{
	...
	public class ISteamClient009 : InteropHelp.NativeWrapper<ISteamClient009VTable>
	{
		...
		{
			return InteropHelp.CastInterface<TClass>( this.GetFunction<NativeGetISteamUserIIS>( this.Functions.GetISteamUser5 )( this.ObjectAddress, hSteamUser, hSteamPipe, InterfaceVersions.GetIFace( typeof( TClass ) ) ) ); 
		}
		...
		{
			return InteropHelp.CastInterface<TClass>( this.GetFunction<NativeGetISteamGameServerIIS>( this.Functions.GetISteamGameServer6 )( this.ObjectAddress, hSteamUser, hSteamPipe, InterfaceVersions.GetIFace( typeof( TClass ) ) ) ); 
		}
		...
		{
			return InteropHelp.CastInterface<TClass>( this.GetFunction<NativeGetISteamFriendsIIS>( this.Functions.GetISteamFriends8 )( this.ObjectAddress, hSteamUser, hSteamPipe, InterfaceVersions.GetIFace( typeof( TClass ) ) ) ); 
		}
		...
		{
			return InteropHelp.CastInterface<TClass>( this.GetFunction<NativeGetISteamUtilsIS>( this.Functions.GetISteamUtils9 )( this.ObjectAddress, hSteamPipe, InterfaceVersions.GetIFace( typeof( TClass ) ) ) ); 
		}
		...
		{
			return InteropHelp.CastInterface<TClass>( this.GetFunction<NativeGetISteamMatchmakingIIS>( this.Functions.GetISteamMatchmaking10 )( this.ObjectAddress, hSteamUser, hSteamPipe, InterfaceVersions.GetIFace( typeof( TClass ) ) ) ); 
		}
		...
		{
			return InteropHelp.CastInterface<TClass>( this.GetFunction<NativeGetISteamMasterServerUpdaterIIS>( this.Functions.GetISteamMasterServerUpdater11 )( this.ObjectAddress, hSteamUser, hSteamPipe, InterfaceVersions.GetIFace( typeof( TClass ) ) ) ); 
		}
		...
		{
			return InteropHelp.CastInterface<TClass>( this.GetFunction<NativeGetISteamMatchmakingServersIIS>( this.Functions.GetISteamMatchmakingServers12 )( this.ObjectAddress, hSteamUser, hSteamPipe, InterfaceVersions.GetIFace( typeof( TClass ) ) ) ); 
		}
		...
		{
			return InteropHelp.CastInterface<TClass>( this.GetFunction<NativeGetISteamGenericInterfaceIIS>( this.Functions.GetISteamGenericInterface13 )( this.ObjectAddress, hSteamUser, hSteamPipe, InterfaceVersions.GetIFace( typeof( TClass ) ) ) ); 
		}
		...
		{
			return InteropHelp.CastInterface<TClass>( this.GetFunction<NativeGetISteamUserStatsIIS>( this.Functions.GetISteamUserStats14 )( this.ObjectAddress, hSteamUser, hSteamPipe, InterfaceVersions.GetIFace( typeof( TClass ) ) ) ); 
		}
		...
		{
			return InteropHelp.CastInterface<TClass>( this.GetFunction<NativeGetISteamGameServerStatsIIS>( this.Functions.GetISteamGameServerStats15 )( this.ObjectAddress, hSteamUser, hSteamPipe, InterfaceVersions.GetIFace( typeof( TClass ) ) ) ); 
		}
		...
		{
			return InteropHelp.CastInterface<TClass>( this.GetFunction<NativeGetISteamAppsIIS>( this.Functions.GetISteamApps16 )( this.ObjectAddress, hSteamUser, hSteamPipe, InterfaceVersions.GetIFace( typeof( TClass ) ) ) ); 
		}
		...
		{
			return InteropHelp.CastInterface<TClass>( this.GetFunction<NativeGetISteamNetworkingIIS>( this.Functions.GetISteamNetworking17 )( this.ObjectAddress, hSteamUser, hSteamPipe, InterfaceVersions.GetIFace( typeof( TClass ) ) ) ); 
		}
		...
		{
			return InteropHelp.CastInterface<TClass>( this.GetFunction<NativeGetISteamRemoteStorageIIS>( this.Functions.GetISteamRemoteStorage18 )( this.ObjectAddress, hSteamuser, hSteamPipe, InterfaceVersions.GetIFace( typeof( TClass ) ) ) ); 
		}
