...
public:
	...
	*/
	...
	virtual void AddRequestLobbyListSlotsAvailableFilter( int ) = 0;
	...
	virtual SteamAPICall_t CreateLobby( ELobbyType eLobbyType, int ) = 0;
	...
	virtual bool GetLobbyDataByIndex( CSteamID steamIDLobby, int iData, char *pchKey, int cubKey, char *pchValue, int cubValue ) = 0;

	virtual unknown_ret DeleteLobbyData( CSteamID steamIDLobby, const char *pchKey ) = 0;
