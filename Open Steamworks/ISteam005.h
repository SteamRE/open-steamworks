...
public:
	...
	virtual int VerifyPassword(const char* cszPasswordToVerify, int* pbIsCorrectPassword, TSteamError* pError) = 0;
	virtual int GetUserType(unsigned int* puUserType, TSteamError* pError) = 0;
	...
	virtual SteamCallHandle_t RefreshAccountInfo(int bUseCachedInfo, TSteamError* pError) = 0;
	...
	virtual int GetAccountStatus(unsigned int* puAccountStatus, TSteamError* pError) = 0;
