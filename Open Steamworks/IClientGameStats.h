...
public:
	...
	virtual EResult _ReportString( uint64 ulSessionID, int, char const*, int, unsigned char const* ) = 0;
	virtual EResult ReportStringAccumulated( uint64 ulSessionID, int32 iSeverity, const char *cszFormat, ... ) = 0;
	virtual EResult _ReportStringAccumulated( uint64 ulSessionID, int, char const*, int, unsigned char const* ) = 0;
