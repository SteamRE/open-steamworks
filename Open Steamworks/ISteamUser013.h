...
public:
	...
	// probably an EVoiceResult return, params are unknown, i'm guessing it kept it's old params
	virtual unknown_ret GetVoice( bool, void *pDestBuffer, uint32 cbDestBufferSize, unsigned int *nBytesWritten, bool, void *, uint32, uint32 * ) = 0;
