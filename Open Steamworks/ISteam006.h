...
public:
	...
	virtual SteamCallHandle_t ChangePassword(const string_t* cszCurrentPassphrase, const string_t* cszNewPassphrase, TSteamError* pError) = 0;
	...
	virtual SteamCallHandle_t ChangePersonalQA(const string_t* cszCurrentPassphrase, const string_t* cszNewPersonalQuestion, const string_t* cszNewAnswerToQuestion, TSteamError* pError) = 0;
	virtual SteamCallHandle_t ChangeEmailAddress(const string_t* cszNewEmailAddress, TSteamError* pError) = 0;
	virtual SteamCallHandle_t VerifyEmailAddress(const string_t* cszEmailAddress, TSteamError* pError) = 0;
	virtual SteamCallHandle_t RequestEmailAddressVerificationEmail(TSteamError* pError) = 0;
	virtual SteamCallHandle_t ChangeAccountName(const string_t* cszCurrentAccountName, const string_t* cszNewAccountName, TSteamError* pError) = 0;
	virtual int MountAppFilesystem(TSteamError* pError) = 0;
	virtual int UnmountAppFilesystem(TSteamError* pError) = 0;
	virtual SteamHandle_t MountFilesystem(unsigned int uAppId, const string_t* szMountPath, TSteamError* pError) = 0;
	virtual int UnmountFilesystem(SteamHandle_t hFile, TSteamError* pError) = 0;
	virtual int Stat(const string_t* cszName, TSteamElemInfo* pInfo, TSteamError* pError) = 0;
	...
	virtual SteamHandle_t OpenFile(const string_t* cszName, const string_t* cszMode, TSteamError* pError) = 0;
	virtual SteamHandle_t OpenFileEx(const string_t* cszFileName, const string_t* cszMode, int iArg3, unsigned int* puSize, int* piArg5, TSteamError *pError) = 0;
	...
	virtual SteamCallHandle_t CreateAccount(const char *cszUser, const char *cszPassphrase, const char *cszCreationKey, const char *cszPersonalQuestion, const char *cszAnswerToQuestion, const string_t* cszArg6, int *pbCreated, TSteamError *pError) = 0;
	virtual SteamCallHandle_t GenerateSuggestedAccountNames(const string_t* cszArg1, const string_t* cszArg2, char* szArg3, unsigned int uArg4, unsigned int* puArg5, TSteamError *pError) = 0;
	...
	virtual int VerifyPassword(const string_t* cszArg1, int* piArg2, TSteamError* pError) = 0;
	...
	virtual SteamCallHandle_t IsAccountNameInUse(const string_t* cszUser, int* pbInUse, TSteamError *pError) = 0;
	...
	virtual SteamCallHandle_t ChangeForgottenPassword(const string_t* cszArg1, const string_t* cszArg2, const string_t* cszArg3, const string_t* cszArg4, int* piArg5, TSteamError *pError) = 0;
	virtual SteamCallHandle_t RequestForgottenPasswordEmail(const string_t* cszArg1, char* szArg2, TSteamError *pError) = 0;
	virtual SteamCallHandle_t RequestAccountsByEmailAddressEmail(const string_t* cszArg1, TSteamError *pError) = 0;
	virtual SteamCallHandle_t RequestAccountsByCdKeyEmail(const string_t* cszArg1, TSteamError *pError) = 0;
	virtual SteamCallHandle_t GetNumAccountsWithEmailAddress(const string_t* cszArg1, unsigned int* puArg2, TSteamError *pError) = 0;
	...
	virtual void Win32SetMiniDumpComment(const string_t* cszComment) = 0;
	...
	virtual void Win32WriteMiniDump(const string_t*, const string_t*, const string_t*, const string_t*, unsigned int) = 0;
	...
	virtual int IsFileNeededByCache(unsigned int uAppId, const string_t* cszFileName, unsigned int uArg3, TSteamError* pError) = 0;
	virtual int LoadFileToCache(unsigned int uArg1, const string_t* cszArg2, const void* pcvArg3, unsigned int uArg4, unsigned int uArg5, TSteamError *pError) = 0;
	...
	virtual int GetSubscriptionExtendedInfo(unsigned int uSubscriptionId, const string_t* cszKeyName, char* szKeyValue, unsigned int uBufferLength, unsigned int* puRecievedLength, TSteamError *pError) = 0;
	...
	virtual const string_t* FindServersGetErrorString() = 0;
